...
const content = {
  sk: {
    ...
    songsTitle: "100+ miliónov skladieb pripravených na vyhľadávanie",
    songsDescription: "Rýchle vyhľadávanie skladieb pre live eventy.",
    songsBadge: "Vyhľadávanie cez Spotify",
    songsSearch: "Nájsť",
  ...
  en: {
    ...
    songsTitle: "100+ million songs ready to search",
    songsDescription: "Fast track search built for live events.",
    songsBadge: "Spotify search",
    songsSearch: "Search",
